...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.api_allow' => ['privates', 'security.firewall.map.context.api_allow', 'getSecurity_Firewall_Map_Context_ApiAllowService.php', true],
            'security.firewall.map.context.api_post_allow' => ['privates', 'security.firewall.map.context.api_post_allow', 'getSecurity_Firewall_Map_Context_ApiPostAllowService.php', true],
            ...
            'security.firewall.map.context.api_allow' => '?',
            'security.firewall.map.context.api_post_allow' => '?',
            ...
            yield 'security.firewall.map.context.api_allow' => ($this->privates['.security.request_matcher.p4VlLPC'] ?? ($this->privates['.security.request_matcher.p4VlLPC'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api')));
            yield 'security.firewall.map.context.api_post_allow' => ($this->privates['.security.request_matcher.AeqwxS8'] ?? ($this->privates['.security.request_matcher.AeqwxS8'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/posts/create')));
        ...
        }, 6)), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), ($this->privates['security.logout_url_generator'] ?? $this->getSecurity_LogoutUrlGeneratorService()));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.authentication.provider.anonymous.api_allow'] ?? ($this->privates['security.authentication.provider.anonymous.api_allow'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 2 => ($this->privates['security.authentication.provider.anonymous.api_post_allow'] ?? ($this->privates['security.authentication.provider.anonymous.api_post_allow'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'console.command.ids' => [
                ...
                14 => 'console.command.public_alias.fos_oauth_server.clean_command',
                15 => 'console.command.public_alias.fos_oauth_server.create_client_command',
            ],
        ];
    }
}
