...
class HKAttendance2 extends Modal 
{
    ...
    public function db_update()
    {
        ...
        if (DBS::execute_update("player_attendance", $key_values, $conditions) == 1) {
            return true;
        }
    }
    ...
    public static function db_parameters($alias = Attendance2::DB_TABLE_ALIAS, $filter = NULL)
    {
        ...
        $parameters[Attendance2::DB_TEAM] = "(SELECT JSON_OBJECT(" . UTS::query_params(Team::db_parameters(NULL), true) . ") FROM team_master WHERE id=" . (($alias) ? $alias . "." : "") . Attendance2::DB_TEAM . " LIMIT 0,1)";
        ...
        // $parameters[Attendance2::DB_COACH] = (($alias) ? $alias . "." : "") . Attendance2::DB_COACH;
